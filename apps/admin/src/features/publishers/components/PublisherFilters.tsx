    ...
    <div className="flex flex-col w-full">
      <div className="flex items-center gap-6 px-4 pt-4">
        ...
        >
          All
          {currentStatus === "" && (
            <motion.div layoutId="publisherStatusIndicator" className="absolute -bottom-px left-0 w-full h-0.5 bg-red-600 rounded-t-sm" transition={{ type: "spring", stiffness: 300, damping: 30 }} />
          )}
        </button>
        <button
