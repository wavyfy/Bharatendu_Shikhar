...
export function SearchButton({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      <span className="absolute left-5 text-sm font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">लेख खोजें...</span>
